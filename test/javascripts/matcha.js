(function( global, factory ) {
  ...
  "use strict";
  var $, CustomComponent, DataList, DropdownList, LIB_CONFIG, Score, createComponent, dataFlag, defineProp, eventName, hook, isTrue, storage, __LIB,
  ...
  hook = function(name, no_dot) {
    return (no_dot === true ? "" : ".") + "js-" + __LIB.namespace(storage, "hook." + name);
  };
  ...
  __LIB.addComponent("score", createComponent(Score, function() {
    if (__LIB.browser.msie && __LIB.browser.version * 1 < 9) {
